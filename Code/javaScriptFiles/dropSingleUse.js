...
class ShockwaveNukeEffect extends StaticEntity {
    ...
    render(ctx, player, enemyItemDrops, position) {
        ...
        ctx.beginPath()
        ctx.arc(this.globalEntityX - leftBorder, this.globalEntityY - topBorder, this.radius, 0, Math.PI * 2)
...
export class NukeDrop extends DropSingleUse {
    ...
    apply(player) {
        ...
        player.enemyItemDrops.push(new ShockwaveNukeEffect(player.globalEntityX, player.globalEntityY))
    }
}
